...
class _GroupManagementPageState extends State<GroupManagementPage> {
  ...
  Future<void> removeMember(String id) async{try{await db.rpc('remove_group_member',params:{'p_conversation_id':widget.conversationId,'p_user_id':id});await load();_toast('عضو حذف شد.');}catch(e){_toast('حذف عضو ناموفق بود: $e');}}
